        ...
        def css_assets_map
          {
            ...
            :bootstrap3 => [" *= require dataTables/bootstrap/3/dataTables.bootstrap\n"],
            :foundation => [" *= require dataTables/foundation/dataTables.foundation\n"],
            :responsive => [" *= require dataTables/extras/dataTables/responsive.dataTables\n"]
          }
        end
      end
    end
